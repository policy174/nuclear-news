...
def _system_prompt() -> str:
    ...
    lines += [
        ...
        "- 사건의 성격이 먼저, 대상 설비의 수명 단계는 그 다음이다. 규제기관 제도 개편, 자료 위조·은폐 인정,",
        "  경영진 사임 같은 '제도·위반·책임' 사건은 대상이 해체 문서든 내진 자료든 규제다.",
        "- 원자력과 무관한 이슈만 domain 을 빈 문자열로 둔다.",
        "",
        "예시:",
        "- 미국 NRC, 원전 인허가·해체·운영 감독 규제 전면 개편안 공개 → 규제 / 해외규제 ('해체' 낱말에 끌리지 말 것)",
        "- 주부전력, 하마오카 원전 폐로 문서 제출 전 위조 인정, 경영진 사임 → 규제 / 해외규제 (위반·책임 사건)",
        "- 원안위, 생활방사선법 하위규정 개정안 등 2건 의결 → 규제 / 원안위 ('핵연료물질' 낱말은 무관)",
        "- 한빛 2호기 설계수명 만료로 가동 중단, 계속운전 심사 대기 → 계속운전 / 계속운전",
        "- 한국 정부·한수원, 웨스팅하우스 지분 인수 검토 → 해외사업 / 합작지분투자",
        "- 체코 규제기관, 웨스팅하우스 핵연료 사용 승인 → 핵연료 / 핵연료제조 (규제가 아니라 대상 칸)",
        "",
