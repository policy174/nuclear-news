...
- title_kr: 한국어 제목 (30~60자). **번역이 아니라 요약 헤드라인이다 — 클릭 없이 제목만으로 요점을 알 수 있게 쓴다.** 인명·기관명 첫 등장 시 한글(원문) 병기.
  · 행위 주체(기관·기업·정부명)를 원문에서 특정할 수 있으면 제목에 명시한다. (X) "정부, 신규 원전 검토" → (O) "산업통상부, 신규 원전 2기 건설 검토"
